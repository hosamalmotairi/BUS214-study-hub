...
const MID2_FLASHCARDS = [
  ...
  { ch:"ch1", front:"Corporate Intelligence", back:"Collection and analysis of information on markets, technologies, customers, competitors, external trends. Three models: (1) passive monitoring (2) tactical field support (3) top-management strategy support. | الاستخبارات المؤسسية." },
...
const MID2_TESTBANK = [
  ...
  { ch:"ch1", q:"Twenty-seven states have introduced the Healthy Workplace Bill to consider ways to combat which of the following?", opts:["Bullying", "Sexual harassment", "Obesity", "Discrimination", "Substance abuse"], ans:0, exp:"Healthy Workplace Bill تم تقديمه في 27 ولاية لمكافحة التنمر في مكان العمل (Workplace Bullying). الولايات المتحدة ليس لديها قوانين فدرالية ضد التنمر." },
  { ch:"ch1", q:"Accountants must abide by a strict code of ethics that defines their responsibilities to which of the following?", opts:["Only their clients only", "Both their clients and the public interest", "Only the public only", "Both their investors and shareholders", "Only government regulators"], ans:1, exp:"المحاسبون ملتزمون بمدونة أخلاقيات تحدد مسؤولياتهم تجاه العملاء والمصلحة العامة معاً — هذا توازن مهم يضمن الشفافية المالية." },
  ...
  { ch:"ch1", q:"A company can be sued for discrimination if it does which of the following?", opts:["Unilaterally abuses or intimidates its employees", "Creates an anticompetitive corporate culture", "Discharges a minority individual, but has a just cause for doing so", "Uses age as a hiring or firing criterion", "Has more men than women on staff"], ans:3, exp:"التمييز على أساس العمر (تحت حماية ADEA) ممنوع قانونياً في التوظيف والفصل. الأقليات يمكن فصلهم لسبب عادل. EEOC تحمي من التمييز في مكان العمل." },
  ...
  { ch:"ch1", q:"Which type of fraudulent activity could involve a consumer staging an accident in order to seek damages?", opts:["Whacking", "Duplicity", "Guile", "Defamation", "Collusion"], ans:1, exp:"Duplicity (الازدواجية/الخداع) = مثل تمثيل حادث لطلب تعويض، أو شراء ملابس ولبسها ثم إرجاعها، أو طلب استرداد بادعاء عيب." },
  ...
  { ch:"ch2", q:"The relevance or importance of an ethical event or decision in the eyes of the individual, work group, and/or organization is referred to as _______.", opts:["organizational culture", "immediate job context", "ethical issue intensity", "leadership", "locus of control"], ans:2, exp:"Ethical Issue Intensity = أهمية الحدث الأخلاقي في نظر الفرد أو مجموعة العمل أو المنظمة. شخصي ومؤقت بطبيعته — يتأثر بالقيم والمعتقدات والضغوط." },
  ...
  { ch:"ch3", q:"The belief that no one thing is intrinsically good is defined as _______.", opts:["hedonism", "pluralism", "relativism", "deontology", "teleology"], ans:1, exp:"Pluralism (التعددية) = لا شيء واحد خير بطبيعته. عكس Monism. Pluralists = Nonhedonists. Plato قال أن الخير مزيج من عدة عناصر." },
