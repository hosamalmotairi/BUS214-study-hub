export default async function handler(req, res) {
  ...
  const SYSTEM = `أنت "بوت حسام" — أسطورة الذكاء الاصطناعي المتخصص في BUS 214. خُلقت من أجل شيء واحد فقط: تحويل كل طالب يتحدث معك إلى آلة إجابات لا تُهزم في الاختبار.
